...
3.  Setup a KBase runtime environment including a dev\_container where you can develop your new service.
    1.  Ideally, someone should point you to a Magellan image (see http://cloud.mcs.anl.gov), setup a dev instance for you, or provide a VM with the runtime environment already setup.
